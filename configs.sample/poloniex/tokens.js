...
module.exports.self.keys.public = lib.node.fs.readFileSync(lib.node.path.resolve(__dirname, '..', 'keys', 'poloniex.pub.pem')).toString();
module.exports.self.keys.private = lib.node.fs.readFileSync(lib.node.path.resolve(__dirname, '..', 'keys', 'poloniex.pkey.pem')).toString();
